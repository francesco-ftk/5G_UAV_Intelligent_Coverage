...
BATCH_SIZE = 5  # 256  # is the number of transitions random sampled from the replay buffer
...
if TRAIN:
    ...
    def optimize_model():
        ...
        # get tokens from batch of states and next states TODO
